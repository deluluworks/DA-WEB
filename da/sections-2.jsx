    ...
    <section style={{ paddingTop: 'var(--section-pad-y)' }}>
      ...
      <div className="da-wrap" style={{ marginTop: 24 }}>
        <div style={{ position: 'relative', overflow: 'hidden', borderRadius: 'var(--radius-cards)', background: 'var(--color-solar-bloom)', padding: '40px 48px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 40 }}>
          ...
          <a href="#thinking" style={{ flex: '0 0 auto', display: 'inline-flex', alignItems: 'center', gap: 10, textDecoration: 'none', background: 'var(--color-obsidian-ink)', color: 'var(--color-paper-white)', padding: '16px 28px', borderRadius: 999, fontFamily: D, fontWeight: 400, textTransform: 'uppercase', letterSpacing: '0.04em', fontSize: 13, whiteSpace: 'nowrap' }}>
...
function DAPortfolio() {
  ...
  return (
    <section style={{ paddingTop: 'var(--section-pad-y)', paddingBottom: 'var(--section-pad-y)' }}>
      <div className="da-wrap" style={{ display: 'grid', gridTemplateColumns: '35fr 65fr', gap: 80, alignItems: 'start' }}>
...
function DAPainPoints() {
  ...
  return (
    <section style={{ paddingTop: 'var(--section-pad-y)', paddingBottom: 'var(--section-pad-y)' }}>
      <div className="da-wrap" style={{ display: 'grid', gridTemplateColumns: '32fr 68fr', gap: 64, alignItems: 'start' }}>
...
function DAStats() {
  ...
  return (
    <section style={{ background: 'var(--color-obsidian-ink)', color: 'var(--color-paper-white)', paddingTop: 'var(--section-pad-y)', paddingBottom: 'var(--section-pad-y)' }}>
      <div className="da-wrap" style={{ display: 'grid', gridTemplateColumns: '38fr 62fr', gap: 72, alignItems: 'start' }}>
        <div>
